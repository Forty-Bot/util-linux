 ...
 * @cname: The string representation of the ID
 * @sz: The length of @cname
 *
 * This converts a string into an ID. No name lookup is performed.
 *
 * Return: @cname as a numeric ID
 */
